    ...
    <main>
     ...
     {/* <form className='flex flex-col justify-start items-center gap-4'>
      ...
      <form className='flex flex-col justify-start items-center gap-4' onSubmit={handleSubmit}>
        <input type='text' id='firstName' placeholder='First Name' className="border p-4 rounded"></input>
        {/* <input type='text' id='lastName' placeholder='Last Name' className="border p-4 rounded"></input> */}
        {/* <input type='email' placeholder='Email' className="border p-4 rounded" /> */}
        <input type="submit" className="border p-4 text-lg rounded bg-blue-500" ></input>
      </form>
